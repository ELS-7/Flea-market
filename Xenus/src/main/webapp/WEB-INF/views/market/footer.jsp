	...
	<div class="container">
		<div class="wthree-foo-grids">
			...
			<div class="col-md-3 wthree-footer-grid">
				...
				<p>Flea Market is a market web page created through a web programming practice project.</p>
			</div>
			<div class="col-md-3 wthree-footer-grid">
			...
			<div class="col-md-3 wthree-footer-grid">
				...
				<address>
					<ul class="location">
						...
						<li>Sungkyunkwan University Undergraduate Counseling Center</li>
					</ul>	
...
<div class="agileits-footer-bottom text-center">
	<div class="container">
		<div class="w3-footer-logo">
			<h1><a href="index.html"><span>Flea</span>Market</a></h1>
		</div>
		...
		<div class="copyrights">
			<p> © 2022 SKKU All Rights Reserved | Design and Developed by JB </p>
		</div>
		<div class="clearfix"></div>
	</div>
</div>
